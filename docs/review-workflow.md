...
`review.config.json` の明示登録教材だけを対象とする。現在は哲学3・基本情報1・簿記2・AI2・仕事1・プロンプト2・勉強8の計19ファイル。
...
既存54問のIDと内容は維持している。
2026-09-20に教材分類と参照パスを更新した。全74問のID・解答・revisionは維持し、移動の詳細は[分類方針](category-organization.md)に記録している。教材の全章を網羅する問題集ではない。
